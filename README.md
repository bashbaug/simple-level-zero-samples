...
[![build](https://github.com/bashbaug/simple-level-zero-samples/actions/workflows/build.yml/badge.svg?branch=main)](https://github.com/bashbaug/simple-level-zero-samples/actions?query=workflow%3Abuild+branch%3Amain)
